...
export default class BaiTapPhim extends Component {
  ...
  renderBTPhim = () => {
    return this.dataPhim.map((dataPhim, index) => {
      return (
          ...
          <div className="card text-left">
            ...
            <div
              style={{
                ...
                backgroundImage: `url('${dataPhim.hinhAnh}')`,
              }}
            >
              <img
            ...
            <div className="card-body">
              ...
              <p style={{ height: "70px" }} className="card-text">
                {dataPhim.moTa.length > 100 ? (
                  <span>{dataPhim.moTa.substr(0, 100)}...</span>
                ) : (
                  <span>{dataPhim.moTa}</span>
                )}
              </p>
            </div>
          </div>
  ...
  render() {
    return (
      <div className="container">
        <h1 className="text-center display-4">Danh Sach Phim</h1>
        <div className="row">{this.renderBTPhim()}</div>
      </div>
    );
  }
}
